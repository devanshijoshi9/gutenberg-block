...
function Edit(_ref) {
  ...
  const onChangePostLink = newPostLink => {
    setAttributes({
      postLink: newPostLink === undefined ? '' : newPostLink
    });
  };
